...
class MyFunctions:
    ...
    @staticmethod
    def check_sample_ratio_edges(distribution_name: str, file_name: str, sample_len: int) -> float:
        func_dict = {
    ...
    @staticmethod
    def check_sample_ratio_max_degrees(distribution_name: str, file_name: str, sample_len: int) -> float:
        func_dict = {
    ...
    @staticmethod
    def check_sample_ratio_components(distribution_name: str, file_name: str, sample_len: int) -> float:
        func_dict = {
